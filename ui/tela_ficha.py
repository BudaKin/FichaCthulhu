...
class TelaFicha(ttk.Frame):
    def __init__(self, parent, app):
        ...
        # Salva referência para adicionar perícias dinâmicas
        self.scrollable_skills = scrollable

        # -------- Bind do scroll do mouse --------
        self._bind_mousewheel(canvas)

        # Adiciona perícias fixas
    ...
    # ===== Adicionar novas perícias =====
    def add_language(self, app):
        scrollable = self.scrollable_skills  # adiciona dentro do canvas rolável
